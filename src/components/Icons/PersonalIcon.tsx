...
export const PersonalIcon: React.FC<Props> = ({ color = '#0054FD', size = 14 }) => (
  <svg width={size} height={size * 1.14} viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
